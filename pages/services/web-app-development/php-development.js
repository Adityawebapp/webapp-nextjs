...
<div className="inner_page">
      ...
      <div className="row flex-reverse">
        <div className="col-md-6 col-sm-12 d-flex align-items-center">
          <div className="top_text">
            ...
            <p>
              From Facebook to Wikipedia, the world`s most visited websites are
              built using PHP. Shouldn`t your website also be built using the
              same capable and universally compatible web development framework?
              <b>Webapp </b>`s PHP development services can help you build any kind of
              website to have a sophisticated backend and a user-friendly
              frontend.
            </p>
  ...
  <div className="container development_section">
    <h1 data-aos="fade-out" className="text-center mt-5">
      <span className="mycolor"> Suite of PHP development </span>   <span className="border-bottom"> services</span>
    </h1>
          ...
          <div className="card-body shadow">
            <div className="text-center py-3 development_card">
              <Image
                width="70px"
                height="70px"
                src="/images/icon/web-development.png" alt="web development"
              />
          ...
          <div className="card-body shadow">
            <div className="text-center py-3 development_card">
              <Image
                width="70px"
                height="70px"
                src="/images/icon/content-management.png" alt="content management"
              />
              <h2 className="card-title mb-3">Content Management System</h2>
              <p className="card-text">
      ...
      <div className="col mb-4" data-aos="zoom-in-left">
        <div className="card border-0">
          <div className="card-body shadow">
            <div className="text-center py-3 development_card">
              <Image width="70px"
              height="70px" src="/images/icon/crm.png" alt="crm"/>
          ...
          <div className="card-body shadow">
            <div className="text-center py-3 development_card">
              <Image
                width="70px"
                height="70px"
                src="/images/icon/enterpriseIcon.png" alt="enterprice"
              />
          ...
          <div className="card-body shadow">
            <div className="text-center py-3 development_card">
              <Image
                width="70px"
                height="70px"
                src="/images/icon/Custom-ECommerce.png" alt="custom ecommerce"
              />
              <h2 className="card-title mb-3">Custom eCommerce</h2>
              <p className="card-text">
                An eCommerce store might begin with one product and scale up to
                a million product listings. We will help you scale seamlessly
                and effortlessly with our PHP development expertise.  
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="card-body shadow">
            <div className="text-center py-3 development_card">
              <Image
                width="70px"
                height="70px"
                src="/images/icon/Cloud-SaaS-Application.png" alt="cloud app"
              />
          ...
          <div className="card-body shadow">
            <div className="text-center py-3 development_card">
              <Image
                width="70px"
                height="70px"
                src="/images/icon/Social-Networking-Solutions.png" alt="Social-Networking-Solutions"
              />
              <h2 className="card-title mb-3">Social Networking Solutions</h2>
              <p className="card-text">
          ...
          <div className="card-body shadow">
            <div className="text-center py-3 development_card">
              <Image
                width="70px"
                height="70px"
                src="/images/icon/Backend-Solutions.png" alt="Backend-Solutions"
              />
